...
```dart
// core/di/di.dart (barrel) — only sl and configureDependencies are public API
...
```dart
// data/src/di/data_injection.dart
import 'package:injectable/injectable.dart';
...
```dart
// domain/src/di/domain_injection.dart
import 'package:injectable/injectable.dart';
...
This generates `core/di/injection.config.dart` with all registrations.
...
```dart
// data/src/remote/api/feature/feature_api_module.dart
@module
...
- `src/remote/remote.dart` — remote data source interfaces
- `src/local/local.dart` — local data source interfaces

### Repository — Domain Layer

```dart
// domain/src/authentication/authentication_repository.dart
abstract interface class AuthenticationRepository {
  Future<void> login({required String email, required String password});
}

// domain/src/authentication/authentication_repository_impl.dart
...
```dart
// use_case/account/determine_account/determine_account_uc.dart
abstract interface class DetermineAccountUseCase {
  Future<void> call();
}

// use_case/account/determine_account/determine_account_uc_impl.dart
...
use_case        → depends on domain, entity
screens         → depends on domain, use_case, entity

ENFORCE: No upward dependencies (domain never imports screens)
```
...
- [ ] Create `src/di/` with `@InjectableInit.microPackage()` init
